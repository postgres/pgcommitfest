...
urlpatterns = [
    ...
    re_path(r"^contrib-card/$", views.contrib_card),
    re_path(r"^contrib-card/lookup/$", views.contrib_card_lookup),
    re_path(r"^contrib-card/stats/$", views.contrib_card_stats),
    re_path(r"^contrib-card/(?P<handle>[^/]+)/?$", views.contrib_card),
