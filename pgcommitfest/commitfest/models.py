...
class CommitFest(models.Model):
    ...
    def _should_auto_move_patch(self, patch, current_date):
        ...
        A patch qualifies for auto-move if:
        1. It has had email activity within the configured number of days
        2. It hasn't been failing CI for longer than the configured threshold
        """
